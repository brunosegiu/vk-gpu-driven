...
layout(binding = 1, set = UPDATE_PER_FRAME) uniform texture2DArray uPrevIrradianceTargets;
layout(binding = 2, set = UPDATE_PER_FRAME) uniform texture2DArray uPrevProbeMoments;
